package hgGame.socket.command.s41
{
	...
	public class SCMD41007
	{

		public var a_aresult:Int16;
		...
		public var o2_grow:int; //成长值(0414新增2为训练状态)
		public var p_fight:Int16; //出战标志(0 休息 1 出战 2为训练状态)
...
//		public var t2_skill4Effect:Int32;
		...
		public var x_trainingTime:int; //训练时间(0414新增)
		public var z1_isChangeBody:Int32;//是否已经化形(大于0就是已经化形)
		public var z2_fightSkillArray:Array = [new SCMDFightSkillItem];
		public function SCMD41007()
		{
		}
